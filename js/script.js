...
// HEADER MENU BURGER
const navLinks = document.querySelector('.header-menu__hamburger-wrapper'),
  hamburger = document.querySelector('.header-menu__hamburger-line');
...
if (innerWidth < 992) {
  document.addEventListener('click', (e) => {
    e.target && e.target.closest('.header-menu__hamburger-line') === hamburger ? toggle() : e.target.closest('.header-menu__hamburger-wrapper') !== navLinks ? remove() : false;
  });
}
...
const modal = document.querySelector('.modal'),
  ...
  modalBbtn = document.querySelectorAll('.modal-btn'),
...
const validate = function (selector, rules, successModal, yaGoal) {
